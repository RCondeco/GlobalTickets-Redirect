...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <nav class=" w-full z-20 top-0 left-0 ">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <div class="flex md:order-2">
                <a href="include/logout.php" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Logout</a>
            </div>
        ...
        <div class="flex justify-center mt-10">
            ...
            <section class="form w-2/3">
                <form id="urlForm" method="post">
                    <div class="relative">
                        <input type="hidden" name="uid" value="<?php echo $userID; ?>">
                        <input type="text" id="long_link" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="e.g. https://example.com" name="long_url" required>
                        <input type="hidden" name="method" value="POST">
                        <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Shorten</button>
                    </div>
                </form>
            </section>
        </div>
    ...
    <!-- Modal -->
    <div id="editModal" class="modal hidden fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
        <div class="bg-white p-8 rounded">
            ...
            <form id="urlFormEdit" method="post">
                ...
                <input type="text" id="short_url" name="short_url" class="border border-gray-300 rounded mb-4 px-3 py-2 w-full" required>
                <label for="long_url" class="block mb-2">Long Url</label>
                <input type="text" id="long_url" name="long_url" class="border border-gray-300 rounded mb-4 px-3 py-2 w-full" required>
                <input type="hidden" id="url_id" name="url_id" class="border border-gray-300 rounded mb-4 px-3 py-2 w-full">
                <input type="hidden" name="method" value="PUT">
                <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">Save</button>
                <button type="button" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded ml-2" onclick="closeModal()">Cancel</button>
            </form>
        </div>
    </div>

    <!-- Modal for delete confirmation -->
    <div id="deleteModal" class="modal hidden fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
        <div class="bg-white p-8 rounded">
            ...
            <form id="urlFormDelete" method="post">
                ...
                <button type="submit" class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded mt-4">Delete</button>
                <button type="button" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded ml-2" onclick="closeDeleteModal()">Cancel</button>
            </form>
        </div>
    </div>
